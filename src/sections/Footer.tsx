...
export default function Footer() {
  ...
  const companyItems = [
    ...
    { label: t('فهرس الموقع بالكامل', 'Site Directory Map'), path: '/index' },
              ...
              {companyItems.map((item) => (
                <li key={item.label}>
                  {item.path ? (
                    <Link
                      to={item.path}
                      className="font-body text-sm text-slate-600 hover:text-gold transition-colors text-start inline-block"
                    >
                      {item.label}
                    </Link>
                  ) : item.id ? (
          ...
          <div>
            ...
            <ul className="space-y-3 p-0 m-0 list-none text-start">
              <li className="font-body text-sm text-slate-600">
                <a href={PHONE_LINK} className="hover:text-gold transition-colors inline-block">
                  <span dir="ltr">+20 10 50078365</span>
                </a>
              </li>
              <li className="font-body text-sm text-slate-600">
                <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors inline-block">
                  <span dir="ltr">+20 11 19908096</span>{t(' (واتساب)', ' (WhatsApp)')}
                </a>
              </li>
              <li className="font-body text-sm text-slate-600">
