...
export default function Statistics() {
  ...
  const stats = [
    { value: 100, suffix: '+', label: t('حافلة ومركبة حديثة', 'Modern Buses & Vehicles') },
    { value: 99.2, suffix: '%', label: t('معدل الالتزام بالمواعيد', 'On-Time Punctuality Rate'), isDecimal: true },
    { value: 25, suffix: '+', label: t('عميل وشركة متعاقدة', 'Corporate Clients') },
    { value: 11, suffix: '+', label: t('عاماً من الخبرة والريادة', 'Years of Industry Experience') },
    { value: 85, suffix: '+', label: t('سائق محترف ومعتمد', 'Certified Professional Drivers') },
    { value: 5000, suffix: '+', label: t('رحلة آمنة شهرياً', 'Safe Monthly Trips') },
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // تأثير الظهور التدريجي لعناصر الإحصائيات
